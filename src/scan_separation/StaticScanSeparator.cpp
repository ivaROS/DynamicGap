...
namespace dynamic_gap
{
    ...
    sensor_msgs::LaserScan StaticScanSeparator::staticDynamicScanSeparation(const std::vector<dynamic_gap::Gap> & observed_gaps, 
    ...
    std::vector<Eigen::Matrix<float, 4, 1> > StaticScanSeparator::getCurrAgents() {
        return curr_agents;
    }
}