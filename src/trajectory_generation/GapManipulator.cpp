...
namespace dynamic_gap 
{
    ...
    {
        if (cfg_->debug.manipulation_debug_log) ROS_INFO_STREAM("    [setTerminalGapWaypoint()]");
    ...
    void GapManipulator::reduceGap(dynamic_gap::Gap& gap, geometry_msgs::PoseStamped localgoal, bool initial) 
    {
