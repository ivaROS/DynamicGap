        ...
        public:
            ...
            */
            struct Robot 
            {
                ...
                float vang_absmax = 2.0; /**< Maximum angular speed for robot */            
                // float a_max = 2.0; /**< manaully set this in the planner file todo: update this value i just randomly picked it. Maximum angular speed for robot */      
            } rbt;
