...
namespace dynamic_gap {
    ...
    struct clf_cbf {
        ...
        double cbf_left(const state_type &x, Eigen::Vector2d left_rel_pos_rbt_frame, Eigen::Vector2d left_rel_vel_rbt_frame) {
            ...
            double r = left_rel_pos_rbt_frame.norm();
        ...
        double cbf_right(const state_type &x, Eigen::Vector2d right_rel_pos_rbt_frame, Eigen::Vector2d right_rel_vel_rbt_frame) {
            ...
            double r = right_rel_pos_rbt_frame.norm();
        ...
        Eigen::Vector2d cbf_partials_right(const state_type &x, Eigen::Vector2d right_rel_pos_rbt_frame, Eigen::Vector2d right_rel_vel_rbt_frame) {
            ...
            // attempt at revising CBF: -r*betadot
            ...
            // previous CBF with potential r_min error:
        ...
        void operator()(const state_type &x, state_type &dxdt, const double t)
        {
            ...
            // std::cout << "a_des: " << a_des(0) << ", " << a_des(1) << std::endl;
            ...
            if (h_dyn_left < h_dyn_right && !invalid_left) {
                h_dyn = h_dyn_left;
                d_h_dyn_dx = d_h_dyn_left_dx;
            } else if (h_dyn_right < h_dyn_left && !invalid_right) {
                h_dyn = h_dyn_right;
            ...
            // std::cout << "Psi is " << Psi << " with cbf param: " << cbf_param << std::endl;
            ...
            */
            ...
            // calculate acceleration
            // these need to be in world frame?
            double a_x_rbt = result(0); //-K_acc*(x[2] - result(0));
            double a_y_rbt = result(1); //-K_acc*(x[3] - result(1));
